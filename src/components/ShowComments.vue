      ...
      <div class="content">
        <div class="cards">
          <div v-for="item in items" :key="item.id" class="card">
            <div class="box">
              <h2>Reported User Id: {{ item.comment.userId }}</h2>
              <h3>Reported Content: {{ item.comment.body }}</h3>
              <h3>Reported Comment Id: {{ item.comment.id }}</h3>
            </div>
            <div class="icon-case">
              <button>
                <img
                  src="../assets/likee.png"
                  width="45px"
                  height="45px"
                  alt=""
                />
